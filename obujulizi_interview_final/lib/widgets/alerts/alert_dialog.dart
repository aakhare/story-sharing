                                ...
                                ? () {
                                    if (radioValue == 1) {
                                      Navigator.pushNamed(context,
                                          RoutesName.createTextInterview, arguments: profileId);
                                    } else if (radioValue == 2) {
                                      Navigator.pushNamed(context,
                                          RoutesName.createAudioInterview, arguments: profileId);
                                    } else {
                                      Navigator.pushNamed(context,
                                          RoutesName.createVideoInterview, arguments: profileId);
                                    }
                                  }
                                : null,
