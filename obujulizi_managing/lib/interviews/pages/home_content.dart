        ...
        child: Column(children: [
            ...
            child: Padding(
              ...
              child: Column(
                children: const [
                  ...
                  mediumVertical,
                  Text(
                      "Here, you will view past interview details and create stories accordingly. You will also be able change the status of interviews and to create and save story drafts. Once those drafts are approved, they will be published by an admin member and become a story.",
                      style: otherBody),
                ],
              ),
            ),
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const Text(
                ...
                style: bodyText3),
            smallVertical,
            const Text("• Only publish a story if you are an admin member",
                style: bodyText3),
            smallVertical,
